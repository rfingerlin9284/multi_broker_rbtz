...
try:
    from rick_hive.rick_local_ai import RickLocalAI, RickAIResponse
    AI_AVAILABLE = True
except ImportError:
    AI_AVAILABLE = False
...
LEARNING_DB = Path("rick_hive/rick_learning.db")
CORE_PROMPT_FILE = Path("rick_hive/RICK_CORE_PROMPT.txt")
