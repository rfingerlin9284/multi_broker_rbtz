...
# Import RickCharter from foundation
try:
    import sys
    from pathlib import Path
    sys.path.insert(0, str(Path(__file__).parent.parent / 'MULTI_BROKER_PHOENIX'))
    ...
    class RickCharter:
        ...
        FOREX_AI_HIVE_VOTE_CONSENSUS = 0.80
        CRYPTO_HIVE_CONSENSUS_APPLIES_TO = ['BTC-USD', 'ETH-USD', 'BTC', 'ETH']
        CHARTER_PIN = "841921"
