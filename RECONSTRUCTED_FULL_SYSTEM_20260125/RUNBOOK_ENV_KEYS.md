...
FOUND:
  toggles  = /path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/config/toggles.env
  secrets  = /path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/ops/secrets.env
...
```json
{
  ...
  "toggles_path": "/path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/config/toggles.env",
  "secrets_path_used": "/path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/ops/secrets.env",
...
```bash
chmod +x /path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/tools/env_load.sh
```
...
```bash
chmod 600 /path/to/RECONSTRUCTED_FULL_SYSTEM_20260125/ops/secrets.env
```
